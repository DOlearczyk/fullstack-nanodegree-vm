...
def testStandingsBeforeMatches():
    ...
    [(id1, name1, wins1, ties1, matches1, points1, ranking1),
     (id2, name2, wins2, ties2, matches2, points2, ranking2)] = standings
    if matches1 != 0 or matches2 != 0 or wins1 != 0 or wins2 != 0 \
            or ties1 != 0 or ties2 != 0:
        raise ValueError(
            "Newly registered players should have no matches, ties or wins.")
...
def testReportMatches():
    ...
    standings = playerStandings()
    for (i, n, w, t, m, p, s) in standings:
        if m != 1:
